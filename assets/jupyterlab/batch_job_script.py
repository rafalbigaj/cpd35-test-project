...
# Authenticate to the Watson Machine Learning service on IBM Cloud Pack for Data.
...
username = 'demouser'
password = 'password'
url = 'https://cpd350-cpd-cpd350.apps.wml-kf-cluster.os.fyre.ibm.com'
...
input_dir = os.getenv('BATCH_INPUT_DIR', '~/input')
work_dir = os.getenv('WORKDIR', '~/workdir') 
jobs_payload_path = os.getenv('JOBS_PAYLOAD_FILE')
